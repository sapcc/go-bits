...
rm -rf -- ../migrate/
cp -R vendor/github.com/golang-migrate/migrate/ ../migrate/
...
find ../migrate/ -type f -exec sed -i 's+"github.com/golang-migrate/migrate+"github.com/sapcc/go-bits/easypg/migrate+' {} +
